...
def get_paths():
    if platform.system() == "Windows":
        path_driver = os.path.dirname(os.path.realpath(__file__)) + "/../drivers/chromedriver.exe"
        path_chrome = (
            os.path.dirname(os.path.realpath(__file__)) + "7../drivers/chrome-win64/chrome.exe"
        )
    else:
        path_driver = (
        ...
        path_chrome = (
            os.path.dirname(os.path.realpath(__file__)) + "/../drivers/chrome-linux64/chrome"
        )
    path_downloads = "./"
